    ...
    <div class="mx-auto h-full flex justify-center items-center bg-gray-300">
        <div class="w-96 bg-blue-900 rounded-lg shadow-all p-6">
            ...
            <form class="pt-8" method="POST" action="{{ route('login') }}">
                ...
                <div class="relative">
                    <label for="email"
                           class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">{{ __('E-Mail') }}</label>
...
@error('email')
                ...
                <div class="relative pt-3">
                    <label for="password"
                           class="uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2">{{ __('Password') }}</label>
 ...
 @error('password') is-invalid @enderror" name="password"  autocomplete="current-password">
                ...
                <div class="pt-8">
                    <button type="submit"
                            class="w-full py-2 px-3 text-left  bg-gray-400 uppercase rounded text-blue-800 font-bold">
                        {{ __('Login') }}
                    </button>
                </div>
